...
export function Header() {
    ...
    return (
        <header className="bg-white h-20 py-2 px-2 flex items-center justify-center shadow-sm shadow-[#6C0020]">
            <div className="flex  mx-auto items-center justify-between w-full max-w-7xl">
                ...
                <nav className="flex items-center gap-4">
                    <Link href="/cachorros" className="text-[#6C0020] font-bold hover:text-[#C7033D] duration-300"><span className="sr-only">Pagina cachorros</span>Cachorros</Link>
                    <Link href="/gatos" className="text-[#6C0020] font-bold hover:text-[#C7033D] duration-300" ><span className="sr-only">Pagina gatos</span>Gatos</Link>
                    <Link href="aves" className="text-[#6C0020] font-bold hover:text-[#C7033D] duration-300"><span className="sr-only">Pagina aves</span>Aves</Link>
                </nav>
