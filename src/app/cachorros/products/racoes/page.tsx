...
import { buscarProdutosCachorrosRacao } from "../../_actions/_all-products/get-products"
import Image from "next/image"
import { HeartIcon, PlusCircleIcon } from "@phosphor-icons/react/dist/ssr"
import Link from "next/link"
import { AddCart } from "@/components/addCart"

export default async function RacoesDog() {

    const buscarRacoes = await buscarProdutosCachorrosRacao()
    const listaRacoes: ProdutoProp[] = buscarRacoes.produtos as ProdutoProp[]
