...
import { getBrinquedosCats, getHigieneCats } from "../../_actions/all-products/get-products";
import Image from "next/image";
import { HeartIcon, PlusCircleIcon } from "@phosphor-icons/react/dist/ssr";
import Link from "next/link";


export default async function HigieneCats() {
    const produtosGatos = await getHigieneCats();
    const higiene: ProdutoProp[] = produtosGatos.higiene as ProdutoProp[];
