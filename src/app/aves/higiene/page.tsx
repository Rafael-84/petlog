...
export default async function HigieneAves() {
    const higieneAves = await getHigieneAves();
    const higiene: ProdutoProp[] = higieneAves.higiene as ProdutoProp[];
    ...
    return (
        ...
        <main>
            <section className="flex flex-col">
                <div className="mb-8">
                    <h2 className="text-xl text-[#6C0020] font-medium ">Higiene e Cuidados</h2>
                </div>
